...
/**
 * This API's view of the rule-authoring copilot (Phase 2 design doc §2.3) -- the first call this system
 * makes in the API-to-AI direction; Task 2's Policy Q&A calls the other way.
 *
