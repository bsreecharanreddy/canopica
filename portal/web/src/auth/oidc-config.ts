...
const REALM_CHOICE_KEY = 'ies-realm-choice';
...
const REALM_CONFIG: Record<Realm, { authority: string; client_id: string }> = {
  citizen: {
    authority: `${KEYCLOAK_BASE_URL}/realms/ies-citizens`,
    client_id: 'ies-portal-web-citizen',
  },
  worker: {
    authority: `${KEYCLOAK_BASE_URL}/realms/ies-workers`,
    client_id: 'ies-portal-web',
  },
};
