...
import { IesAuthProvider, useIesAuth } from './auth/AuthContext';
...
function AppShell() {
  ...
  // 'choosing' never actually reaches here -- IesAuthProvider renders its own realm-choice screen instead
