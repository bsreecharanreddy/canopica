...
// port whether this UI is served by Vite's dev server or nginx inside Compose -- the browser
// always reaches Keycloak directly, never through the api's proxy (that's /api/ only, see
