"""Triggers a real run of the canopica_pipeline DAG through Airflow's own REST
API against the live Compose stack and asserts it completes -- proves the
DAG is wired correctly (imports, task dependencies, the real canopica_data/dbt
...
AUTH = ("admin", "CanopicaAirflowAdmin123!")
DAG_ID = "canopica_pipeline"

OPERATIONAL_DSN = "postgresql://canopica_app:canopica_app@localhost:5432/canopica_operational"
SERVING_DSN = "postgresql://canopica_app:canopica_app@localhost:5432/canopica_serving"
