...
Usage::
    ...
    uv run python -m canopica_data.synthetic.fetch_pums
...
from canopica_data.synthetic.distributions import age_band
...
def _load_person(raw_csv: bytes) -> pl.DataFrame:
    ...
    # 37/38 (group quarters population) -- Canopica models households, not institutions.
