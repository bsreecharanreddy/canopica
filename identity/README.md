...
- **`canopica-workers`** — caseworker/supervisor accounts. Directly-provisioned
  test users (`worker.sam` / `CanopicaWorker123!`, `supervisor.robin` /
  `CanopicaSupervisor123!`), not real SSO/IdP brokering — brokering to a real
