---
name: ies-design-decision
description: Use when a new IES architecture or tooling choice needs deciding or recording — a new dependency, a stack substitution, or an open "should we do X" question — before any code for a new subsystem gets written.
---
